...
The methodology *adaptively* narrows down the grids where errors above certain threshold is found in the previous iteration. Starting from level 1 (middle point of [0,1] domain) 
